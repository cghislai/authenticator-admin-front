...
RELEASE_URL="https://api.github.com/repos/cghislai/authenticator-admin-front/releases/${DOWNLOAD_RELEASE}"
...
curl -L -o /opt/deployment/authenticator-admin-front.downloaded.tgz ${DOWNLOAD_URL}
